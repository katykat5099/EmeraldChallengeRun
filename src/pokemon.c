...
#define RANDOM_SPECIES_EVO_0_COUNT_STARTERS ARRAY_COUNT(gRandomSpeciesEvo0Starters)
static const u16 gRandomSpeciesEvo0Starters[] =
{
    SPECIES_BULBASAUR       ,    //= EVO_TYPE_0,
    SPECIES_CHARMANDER      ,    //= EVO_TYPE_0,
    SPECIES_SQUIRTLE        ,    //= EVO_TYPE_0,
    ...
    SPECIES_BELLSPROUT      ,    //= EVO_TYPE_0,
    SPECIES_GEODUDE         ,    //= EVO_TYPE_0,
    SPECIES_SLOWPOKE        ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_MAGNEMITE       ,    //= EVO_TYPE_0,
    SPECIES_GASTLY          ,    //= EVO_TYPE_0,
    SPECIES_RHYHORN         ,    //= EVO_TYPE_0,
    SPECIES_HORSEA          ,    //= EVO_TYPE_0,
    SPECIES_MAGIKARP        ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_DRATINI         ,    //= EVO_TYPE_0,
    SPECIES_CHIKORITA       ,    //= EVO_TYPE_0,
    SPECIES_CYNDAQUIL       ,    //= EVO_TYPE_0,
    SPECIES_TOTODILE        ,    //= EVO_TYPE_0,
    ...
    SPECIES_MAREEP          ,    //= EVO_TYPE_0,
    SPECIES_HOPPIP          ,    //= EVO_TYPE_0,
    //SPECIES_TEDDIURSA       ,    //= EVO_TYPE_0, //If Ursaluna is added
    SPECIES_SWINUB          ,    //= EVO_TYPE_0,
    SPECIES_HOUNDOUR        ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_ELEKID          ,    //= EVO_TYPE_0,
    SPECIES_MAGBY           ,    //= EVO_TYPE_0,
    SPECIES_LARVITAR        ,    //= EVO_TYPE_0,
    SPECIES_TREECKO         ,    //= EVO_TYPE_0,
    ...
    SPECIES_LOTAD           ,    //= EVO_TYPE_0,
    SPECIES_SEEDOT          ,    //= EVO_TYPE_0,
    SPECIES_CARVANHA        ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_TRAPINCH        ,    //= EVO_TYPE_0,
    SPECIES_ELECTRIKE       ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_NUMEL           ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_SPHEAL          ,    //= EVO_TYPE_0,
    SPECIES_SNORUNT         ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_AZURILL         ,    //= EVO_TYPE_0,
    SPECIES_MEDITITE        ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_SWABLU          ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_DUSKULL         ,    //= EVO_TYPE_0,
    SPECIES_SLAKOTH         ,    //= EVO_TYPE_0,
    SPECIES_WHISMUR         ,    //= EVO_TYPE_0,
    SPECIES_SHUPPET         ,    //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_ARON            ,    //= EVO_TYPE_0,
    SPECIES_RALTS           ,    //= EVO_TYPE_0,
    SPECIES_BAGON           ,    //= EVO_TYPE_0,
    SPECIES_BELDUM          ,    //= EVO_TYPE_0,
    ...
    SPECIES_SHINX             , //= EVO_TYPE_0,
    SPECIES_BUDEW             , //= EVO_TYPE_0,
    SPECIES_BUNEARY           , //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_HAPPINY           , //= EVO_TYPE_0,
    SPECIES_GIBLE             , //= EVO_TYPE_0,
    SPECIES_RIOLU             , //= EVO_TYPE_0, //Two stages, 1 Mega
    SPECIES_SNOVER            , //= EVO_TYPE_0,
    SPECIES_SNIVY             , //= EVO_TYPE_0,
    SPECIES_TEPIG             , //= EVO_TYPE_0,
    SPECIES_OSHAWOTT          , //= EVO_TYPE_0,
...
void PokemonToBattleMon(struct Pokemon *src, struct BattlePokemon *dst)
{
    ...
    dst->type1 = GetTypeBySpecies(gBattleMons[battlerId].species, 1); //tx_randomizer_and_challenges //GetTypeBySpecies(dst->species, 1);
    dst->type2 = GetTypeBySpecies(gBattleMons[battlerId].species, 2); //tx_randomizer_and_challenges //GetTypeBySpecies(dst->species, 2);
    ...
    case EVO_MODE_ITEM_CHECK:
        for (i = 0; i < EVOS_PER_MON; i++)
        {
            ...
            case EVO_ITEM_HOLD_ITEM:
                if (heldItem == gEvolutionTable[species][i].param && ITEM_LINKING_CORD == evolutionItem)
                {
                    heldItem = 0;
                    SetMonData(mon, MON_DATA_HELD_ITEM, &heldItem);
                    targetSpecies = gEvolutionTable[species][i].targetSpecies;
...
{
    return gRandomSpeciesEvo0Starters[RandomSeeded(species, TRUE) % RANDOM_SPECIES_EVO_0_COUNT_STARTERS];
}
...
bool8 CheckPartyTyranitar(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_TYRANITAR)
            return TRUE;
    }
...
bool8 CheckPartyGarchomp(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GARCHOMP)
            return TRUE;
    }
...
bool8 CheckPartyHoundoom(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_HOUNDOOM)
            return TRUE;
    }
...
bool8 CheckPartySalamence(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SALAMENCE)
            return TRUE;
    }
...
bool8 CheckPartyBlastoise(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BLASTOISE)
            return TRUE;
    }
...
bool8 CheckPartyAbomasnow(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_ABOMASNOW)
            return TRUE;
    }
...
bool8 CheckPartyCharizard(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
...
bool8 CheckPartyBanette(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_BANETTE)
            return TRUE;
    }
...
bool8 CheckPartyGengar(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GENGAR)
            return TRUE;
    }
...
bool8 CheckPartyGlalie(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GLALIE)
            return TRUE;
    }
...
bool8 CheckPartyGyarados(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_GYARADOS)
            return TRUE;
    }
...
bool8 CheckPartySlowbro(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SLOWBRO)
            return TRUE;
    }
...
bool8 CheckPartyLucario(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_LUCARIO)
            return TRUE;
    }
...
bool8 CheckPartyMedicham(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_MEDICHAM)
            return TRUE;
    }
...
bool8 CheckPartyLopunny(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_LOPUNNY)
            return TRUE;
    }
...
bool8 CheckPartyPidgeot(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_PIDGEOT)
            return TRUE;
    }
...
bool8 CheckPartyScizor(void)
{
    s32 i;
    for (i = 0; i < PARTY_SIZE; i++)
    {
        if (GetMonData(&gPlayerParty[i], MON_DATA_SPECIES2, 0) == SPECIES_SCIZOR)
            return TRUE;
    }
